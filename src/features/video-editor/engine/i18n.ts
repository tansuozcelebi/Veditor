...
const dict: Record<Lang, Record<string, string>> = {
  tr: {
    ...
    'library.unsupported': '{name}: desteklenmeyen dosya türü. Video, ses veya görsel dosyası seçin.',
    'library.loadError': '{name}: dosya açılamadı.',
    'library.err.codec': '{name}: tarayıcı bu dosyayı açamadı ve otomatik dönüştürme de başarısız oldu. Dosya bozuk olabilir; MP4 (H.264) veya WebM olarak dışarıda dönüştürüp tekrar deneyin.',
    'library.err.timeout': '{name}: dosya okunamadı, süre doldu. Çok büyük dosyalarda bir süre bekleyin ya da dosyayı kısaltıp tekrar deneyin.',
    'library.err.read': '{name}: dosya okunamadı. Dosya taşınmış, silinmiş veya bozuk olabilir.',
    'library.err.decode': '{name}: dosya bozuk görünüyor, çözülemedi.',
    'library.err.csp': '{name}: sitenin güvenlik politikası (CSP) yerel dosyaların açılmasını engelliyor. Sunucu ayarlarında Content-Security-Policy başlığına media-src/img-src/worker-src için blob: ve data: izinleri eklenmeli.',
    'app.cspBlocked': 'Bu sayfanın güvenlik politikası (CSP) yerel dosyaların açılmasını engelliyor; editör çalışmaz. Sunucudaki Content-Security-Policy başlığında media-src, img-src ve worker-src için blob: ve data:, script-src için wasm-unsafe-eval izinleri gerekir.',
    'library.imported': '{n} dosya içe aktarıldı',
    'library.converting': '{name}: tarayıcı bu kodeği açamıyor, dönüştürülüyor… %{pct} ({time})',
    'library.convertingLoad': '{name}: dönüştürücü indiriliyor…',
    'library.convertingServer': '{name}: sunucuda dönüştürülüyor… %{pct} ({time})',
    'library.uploading': '{name}: sunucuya yükleniyor… %{pct}',
    'library.downloading': '{name}: dönüştürülen dosya indiriliyor… %{pct}',
    'library.cancel': 'İptal',
    'library.cancelled': '{name}: dönüştürme iptal edildi',
    'library.converted': '{name} dönüştürüldü ve eklendi',
    ...
    'panel.preview': 'Önizleme', 'panel.timeline': 'Zaman Çizelgesi',
    'layout.title': 'Yerleşim', 'layout.panels': 'Paneller', 'layout.reset': 'Varsayılan yerleşime dön',
    'layout.hint': 'Panelleri göster/gizle, yerleşimi sıfırla (paneller sürüklenerek yeniden düzenlenebilir)',
    'source.title': 'Kaynak Oynatıcı', 'source.add': 'Bu klibi zaman çizelgesine ekle (oynatma kafasına)', 'source.addShort': 'Ekle',
    'source.open': 'Bilgisayardan video seç', 'source.empty': 'Bir medya seçin ya da video dosyalarını buraya sürükleyip bırakın.',
    'source.convertedServer': 'Bu dosya sunucuda dönüştürüldü', 'source.convertedBrowser': 'Bu dosya tarayıcıda dönüştürüldü',
  ...
  en: {
    ...
    'library.unsupported': '{name}: unsupported file type. Pick a video, audio or image file.',
    'library.loadError': '{name}: could not open the file.',
    'library.err.codec': '{name}: the browser could not decode this file and converting it failed too. It may be damaged; convert it to MP4 (H.264) or WebM elsewhere and try again.',
    'library.err.timeout': '{name}: reading the file timed out. Very large files need a moment – try again or shorten the file.',
    'library.err.read': '{name}: the file could not be read. It may have been moved, deleted or is damaged.',
    'library.err.decode': '{name}: the file appears to be damaged and could not be decoded.',
    'library.err.csp': '{name}: the site\'s Content Security Policy blocks local files. The server\'s CSP header needs blob: and data: allowed for media-src, img-src and worker-src.',
    'app.cspBlocked': 'This page\'s Content Security Policy blocks local files, so the editor cannot work. The server\'s CSP header needs blob: and data: for media-src, img-src and worker-src, and wasm-unsafe-eval for script-src.',
    'library.imported': '{n} file(s) imported',
    'library.converting': '{name}: the browser cannot decode this codec, converting… {pct}% ({time})',
    'library.convertingLoad': '{name}: downloading the converter…',
    'library.convertingServer': '{name}: converting on the server… {pct}% ({time})',
    'library.uploading': '{name}: uploading to the server… {pct}%',
    'library.downloading': '{name}: downloading the converted file… {pct}%',
    'library.cancel': 'Cancel',
    'library.cancelled': '{name}: conversion cancelled',
    'library.converted': '{name} converted and added',
    ...
    'panel.preview': 'Preview', 'panel.timeline': 'Timeline',
    'layout.title': 'Layout', 'layout.panels': 'Panels', 'layout.reset': 'Reset to the default layout',
    'layout.hint': 'Show or hide panels and reset the layout (panels can be dragged to rearrange them)',
    'source.title': 'Source Player', 'source.add': 'Add this clip to the timeline (at the playhead)', 'source.addShort': 'Add',
    'source.open': 'Choose a video from this computer', 'source.empty': 'Select a media item, or drag and drop video files here.',
    'source.convertedServer': 'This file was converted on the server', 'source.convertedBrowser': 'This file was converted in the browser',
