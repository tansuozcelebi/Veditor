...
const dict: Record<Lang, Record<string, string>> = {
  tr: {
    ...
    'library.err.codec': '{name}: tarayıcı bu videonun kodeğini açamıyor (ör. HEVC/H.265, AVI, WMV, ProRes). Dosyayı MP4 (H.264) veya WebM olarak dönüştürüp tekrar deneyin.',
  ...
  en: {
    ...
    'library.err.codec': '{name}: the browser cannot decode this codec (e.g. HEVC/H.265, AVI, WMV, ProRes). Convert it to MP4 (H.264) or WebM and try again.',
